...
$(document).ready(function(){
	...
	// $('.dropdown-one').css('display', 'none');
	// $('.dropdown-open').click(function(){
	// 	$(this).parent().parent().parent().find('.dropdown-one').css('display', 'block');
	// 	$(this).parent().parent().parent().find('.dropdown-close').css('display', 'block');
	// 	$(this).css('display', 'none');
	// 	return false;
	// });
	// $('.dropdown-close').click(function(){
	// 	$(this).parent().parent().parent().find('.dropdown-open').css('display', 'block');
	// 	$(this).parent().parent().parent().find('.dropdown-one').css('display', 'none');
	// 	$(this).css('display', 'none');
	// 	return false;
	// });
